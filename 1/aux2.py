...
configs = [(60,71), (60,76), (60,86), (60,96), (50,96), (40,96)]
nc_values = [5, 15, 25, 35, 45]
noise = 0

n_samples = [te - ts + 1 for ts, te in configs]
...
for nc in nc_values:
    ...
    for (ts, te) in configs:

        print("   Intervalo:", ts, "-", te)
...
for nc in nc_values:
    plt.plot(n_samples, results[nc], marker='o', label=f'nc = {nc}')

plt.xlabel('Número de Amostras')
plt.ylabel('Accuracy')
plt.title('Accuracy vs Número de Amostras')
plt.legend()
plt.grid(True)
plt.show()