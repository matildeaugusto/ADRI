...
## ACHO QUE ISTO NAO E A LOSS FUNTION PARA O MODELO ESTRUTURADO DO PROBLEMA, MAS SIM PARA UM MODELO DE REGRESSAO LINEAR, ONDE A PERDA É UMA FUNÇÃO QUADRÁTICA DAS POT - COPILOT COMPLETOU A FRASE - MATILDE   
T, n = P.shape
q = n + n * (n - 1) // 2
X = np.zeros((T, q))
for m in range (time):
...
## ACHO QUE ESTAMOS A FAZER A REGRESSAO COM AS PERDAS TROCADAS, NAO DEVIA SER AS REAIS? - MATILDE
